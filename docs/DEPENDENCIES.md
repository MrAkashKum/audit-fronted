...
| @angular/common           | ^21.2.0        |   21.2.23 | Yes                      | DatePipe and HttpClient APIs                                           |
...
| Response date formatting           | DatePipe from @angular/common                                             |
| JSON requests                      | HttpClient and HttpParams from @angular/common/http                       |
